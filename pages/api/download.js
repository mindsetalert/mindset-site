...
export default async function handler(req, res) {
  try {
    ...
    try {
      ...
      // Redirect to GitHub public download URL
      // Note: Le fichier est public mais protégé par le système de tokens
      // Sans token valide, personne ne peut accéder à ce lien
